...
This project is a reference price feed signer that demonstrates how to retrieve prices from both Coinbase Pro and Binance and sign them with a private key that is securely stored inside [Amazon Key Management Service](https://aws.amazon.com/kms/). It is a [Serverless Framework](https://serverless.com) application. Once deployed, there is no need to spend any time thinking about or managing servers.
...
Harbinger is written and maintained by [Luke Youngblood](http://github.com/lyoungblood) and [Keefer Taylor](https://github.com/keefertaylor). 
